import {
  ...
  toKebabCase,
  toTokenKey
} from "./chunk-ZCDFOBJC.js";
import {
  CommonModule
} from "./chunk-THUNC4NK.js";
import {
  isPlatformBrowser
...
var themeUtils_default = {
  ...
  getCommon({ name = "", theme: theme2 = {}, params, set: set2, defaults: defaults2 }) {
  ...
  getPresetC({ name = "", theme: theme2 = {}, params, set: set2, defaults: defaults2 }) {
    var _a;
    const { preset, options } = theme2;
  ...
  getPresetD({ name = "", theme: theme2 = {}, params, set: set2, defaults: defaults2 }) {
    var _a;
  ...
  getCommonStyleSheet({ name = "", theme: theme2 = {}, params, props = {}, set: set2, defaults: defaults2 }) {
    const common = this.getCommon({ name, theme: theme2, params, set: set2, defaults: defaults2 });
  ...
  getStyleSheet({ name = "", theme: theme2 = {}, params, props = {}, set: set2, defaults: defaults2 }) {
    var _a;
    const options = { name, theme: theme2, params, set: set2, defaults: defaults2 };
  ...
  createTokens(obj = {}, defaults2, parentKey = "", parentPath = "", tokens = {}) {
    Object.entries(obj).forEach(([key, value]) => {
      ...
      if (isObject(value)) {
        this.createTokens(value, defaults2, currentKey, currentPath, tokens);
      } else {
  ...
  transformCSS(name, css2, mode, type, options = {}, set2, defaults2, selector) {
    if (isNotEmpty(css2)) {
      const { cssLayer } = options;
      if (type !== "style") {
